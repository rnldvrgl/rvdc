    ...
    const columns: ColumnDef<ChequeCollection>[] = [
        {
            ...
            cell: ({ getValue }) =>
                getValue()
                    ? <span className="font-mono tabular-nums">{formatDate(getValue() as Date, "MMM dd, yyyy")}</span>
                    : "—",
            enableSorting: true,
        },
        {
        ...
        },
        {
            ...
            cell: ({ getValue }) => <span className="font-mono tabular-nums">{safeCell(getValue())}</span>,
        },
        {
        ...
        },
        {
            ...
            cell: ({ getValue }) => <span className="font-mono tabular-nums">{formatCurrency(getValue() as number)}</span>,
        },
        {

    ...
    return [
        ...
        },
        {
            ...
            cell: ({ getValue }) => {
                ...
                return date ? <span className="font-mono tabular-nums">{formatDate(new Date(date), "MMM dd, yyyy")}</span> : "—"
            },
        },
        {
            accessorKey: "total",
                ...
                if (onRestore) {
                    ...
                    return (
                        <div className="flex items-center gap-2">
                            {daysLeft !== null && (
                                <span
                                    className={`inline-flex items-center gap-1 text-xs font-mono font-medium tabular-nums ${daysLeft <= 3
                                            ? "text-destructive"
                                            : daysLeft <= 7
                                                ? "text-amber-600"

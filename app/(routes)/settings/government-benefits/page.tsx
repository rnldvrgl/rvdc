			...
			>
				...
				<TableCell>
					<div className="text-xs text-muted-foreground">
						<div>
							{format(
								new Date(benefit.effective_start),
								"MMM dd, yyyy",
							)}
						</div>
	...
	return (
		<div className="p-6 space-y-6">
			...
			<Tabs defaultValue="all" className="w-full">
				...
				<TabsContent value="all">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								View and manage all government benefit
								configurations
							</CardDescription>
						</CardHeader>
						<CardContent>
				...
				{(["sss", "philhealth", "pagibig", "bir_tax"] as const).map(
					(type) => (

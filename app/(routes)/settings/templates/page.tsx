        ...
        <Wrapper>
            ...
            >
                                ...
                                {validationMessage ? (
                                    ...
                                    <div className="flex items-center gap-4 rounded-lg bg-muted/40 px-4 py-3">
                                        ...
                                        <div className="text-center">
                                            ...
                                            <p className="text-sm font-semibold">
                                                <AnimatedNumber value={jobOrderNumbers.length} format={{ maximumFractionDigits: 0 }} />
                                            </p>
                                        </div>
                                        <div className="h-8 w-px bg-border" />
                                        <div className="text-center">
                                            ...
                                            <p className="text-sm font-semibold">
                                                <AnimatedNumber value={Math.ceil(jobOrderNumbers.length / 2)} format={{ maximumFractionDigits: 0 }} />
                                            </p>
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="flex items-center gap-2 px-4 py-3 border-b">
                                    ...
                                    {printHistory?.count ? (
                                        <span className="ml-auto rounded-full bg-muted px-2 py-0.5 text-[10px] font-medium leading-none">
                                            <AnimatedNumber value={printHistory.count} format={{ maximumFractionDigits: 0 }} /> record{printHistory.count === 1 ? "" : "s"}
                                        </span>
                                    ) : null}
                                </div>
                                        ...
                                        {totalHistoryPages > 1 && (
                                            <div className="flex items-center justify-between border-t px-4 py-3">
                                                <p className="text-xs text-muted-foreground">
                                                    Page <AnimatedNumber value={historyPage} format={{ maximumFractionDigits: 0 }} /> of <AnimatedNumber value={totalHistoryPages} format={{ maximumFractionDigits: 0 }} />
                                                </p>
                            ...
                            <CardContent className="p-5 space-y-5">
                                ...
                                <div className="flex items-center gap-3 rounded-lg bg-muted/40 px-4 py-3 text-sm">
                                    <div>
                                        ...
                                        <p className="font-semibold">
                                            <AnimatedNumber value={selectedSkuItems.length} format={{ maximumFractionDigits: 0 }} /> item{selectedSkuItems.length === 1 ? "" : "s"}
                                        </p>
                                    </div>
                                    <div className="h-8 w-px bg-border" />
                                    <div>
                                        ...
                                        <p className="font-semibold">
                                            <AnimatedNumber value={skuPage} format={{ maximumFractionDigits: 0 }} /> of <AnimatedNumber value={Math.max(totalSkuPages, 1)} format={{ maximumFractionDigits: 0 }} />
                                        </p>
                                    </div>
                                </div>
                                ...
                                {isLoadingItems ? (
                                    ...
                                    <div className="max-h-120 overflow-auto rounded-lg border bg-background">
                                        <div className="sticky top-0 border-b bg-muted/40 px-3 py-2 text-xs font-medium text-muted-foreground">
                                            <AnimatedNumber value={itemsData?.count ?? 0} format={{ maximumFractionDigits: 0 }} /> total item{(itemsData?.count ?? 0) === 1 ? "" : "s"}
                                        </div>
                                ...
                                {totalSkuPages > 1 && (
                                    <div className="flex items-center justify-between border-t px-3 py-3">
                                        <p className="text-xs text-muted-foreground">
                                            Page <AnimatedNumber value={skuPage} format={{ maximumFractionDigits: 0 }} /> of <AnimatedNumber value={totalSkuPages} format={{ maximumFractionDigits: 0 }} />
                                        </p>
                                        <div className="flex items-center gap-1">
                                            <Button
                                                variant="ghost"
                        ...
                        <Card className="lg:col-span-3">
                            <CardContent className="p-0">
                                <div className="flex items-center gap-2 px-4 py-3 border-b">
                                    ...
                                    <span className="ml-auto rounded-full bg-muted px-2 py-0.5 text-[10px] font-medium leading-none">
                                        <AnimatedNumber value={selectedSkuItems.length} format={{ maximumFractionDigits: 0 }} /> selected
                                    </span>
                                </div>
                                ...
                                <div className="space-y-4 p-4">
                                    ...
                                    <div className="flex items-center gap-3 rounded-lg bg-muted/40 px-4 py-3 text-sm">
                                        <div>
                                            ...
                                            <p className="font-semibold">
                                                <AnimatedNumber value={labelsPerPage} format={{ maximumFractionDigits: 0 }} /> label{labelsPerPage === 1 ? "" : "s"}
                                            </p>
                                        </div>
                                        <div className="h-8 w-px bg-border" />
                                        <div>
                                            <p className="text-[10px] uppercase tracking-wide text-muted-foreground">Pages</p>
                                            <p className="font-semibold">
                                                <AnimatedNumber value={Math.max(1, Math.ceil(selectedSkuItems.length / labelsPerPage))} format={{ maximumFractionDigits: 0 }} />
                                            </p>
                                        </div>
                                    </div>
                ...
                <Sheet open={previewOpen} onOpenChange={(next) => !next && setPreviewOpen(false)}>
                    <SheetContent side="right" className="sm:max-w-5xl! w-full px-6 sm:px-8 py-8 overflow-y-auto">
                        <SheetHeader className="mb-5 pb-5 border-b border-border">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <SheetDescription>
                                        <AnimatedNumber value={jobOrderNumbers.length} format={{ maximumFractionDigits: 0 }} /> template{jobOrderNumbers.length === 1 ? "" : "s"} &middot; <AnimatedNumber value={Math.ceil(jobOrderNumbers.length / 2)} format={{ maximumFractionDigits: 0 }} /> page{Math.ceil(jobOrderNumbers.length / 2) === 1 ? "" : "s"}
                                    </SheetDescription>
                                </div>
                                <Button
                        ...
                        <div className="overflow-auto max-h-[calc(100vh-14rem)] rounded-lg bg-muted p-6 flex flex-col items-center gap-6">
                        ...
                        <SheetHeader className="mb-5 pb-5 border-b border-border">
                            <div className="flex items-center justify-between gap-4">
                                <div>
                                    ...
                                    <SheetDescription>
                                        <AnimatedNumber value={selectedSkuItems.length} format={{ maximumFractionDigits: 0 }} /> label{selectedSkuItems.length === 1 ? "" : "s"} · <AnimatedNumber value={Math.ceil(selectedSkuItems.length / labelsPerPage)} format={{ maximumFractionDigits: 0 }} /> page{Math.ceil(selectedSkuItems.length / labelsPerPage) === 1 ? "" : "s"}
                                    </SheetDescription>
                                </div>
                                <Button
                    ...
                    <AlertDialogContent className="max-w-md">
                        <AlertDialogHeader className="text-center sm:text-center">
                            <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-full bg-info/10">
                                <Printer className="h-7 w-7 text-info" />
                            </div>

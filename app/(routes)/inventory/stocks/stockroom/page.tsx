                                ...
                                <div className="space-y-6 p-6">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-base font-medium">
                                                <AnimatedNumber value={Number(entity.item?.cost_price || 0)} prefix="₱" className="text-base font-medium" />
                                            </p>
                                        </div>
                                        {/*<div>
									<label className="text-sm font-medium text-muted-foreground">
								...
								<div>
									...
									<p className="text-base font-medium">
                                        ...
                                        <div>
                                            ...
                                            <AnimatedNumber value={entity.quantity * Number(entity.item.retail_price)} prefix="₱" className="text-base font-medium" />
                                        ...
                                        <div>
                                            ...
                                            <p className="text-base font-medium">
                                                {(entity.quantity || 0) <= 0 ? (
                                                    <span className="inline-flex items-center gap-1.5 px-2 py-1 rounded-full text-xs font-medium bg-red-100 text-destructive dark:bg-red-900/30 ">

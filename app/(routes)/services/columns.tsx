    ...
    const columns: ColumnDef<Service>[] = [
        ...
        // -- Schedule (compact single line with tooltip) --
        {
            ...
            cell: ({ row }) => {
                ...
                return (
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <div className="flex items-center gap-1 text-xs cursor-default whitespace-nowrap font-mono">
                                {iconEl}
        ...
        // -- Revenue --
        {
            ...
            cell: ({ getValue }) => {
                ...
                return (
                    <AnimatedNumber value={Number(value)} prefix="₱" className="font-medium" />
                )
            },
        },
        ...
        // -- Balance --
        {
            ...
            cell: ({ row }) => {
                ...
                return (
                    <AnimatedNumber value={balance} prefix="₱" className={`font-medium ${balance > 0 ? "text-destructive" : "text-success"}`} />
                )
            },
        },
        ...
        // -- Created date (compact relative) --
        {
            ...
            cell: ({ getValue }) => {
                ...
                return (
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <span className="text-xs font-mono text-muted-foreground cursor-default whitespace-nowrap">
                                {relativeTime(value)}
                            </span>
                        </TooltipTrigger>
                        <TooltipContent className="text-xs font-mono">

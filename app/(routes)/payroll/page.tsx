		...
		<div className="p-6 space-y-6">
			<header className="space-y-1">
				...
				<p className="text-sm text-muted-foreground">
					Add, edit, and delete clock in/out records. These entries
					feed into weekly payroll computations.
				</p>
			</header>
		...
		await updateTimeEntry.mutateAsync({
			...
			data: {
				clock_in: form.clock_in
					? toIsoString(form.clock_in)
					: undefined,
				clock_out: form.clock_out
					? toIsoString(form.clock_out)
					: undefined,
		...
		<tr className="border-b">
			...
			<td className="py-2 pr-2">
				<input
					...
					value={form.clock_in}
					onChange={(e) =>
						setForm((f) => ({ ...f, clock_in: e.target.value }))
					}

...
export default function PayrollSettingsPage() {
  ...
  const handleSave = async () => {
    ...
    if (payload.shift_start) payload.shift_start = toHHMMSS(payload.shift_start)
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  <Input
                    type="time"
                    value={toHHMM(effective.shift_start as string)}
                ...
                >
                  <Input
                    type="time"
                    value={toHHMM(effective.shift_end as string)}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  <Input
                    ...
                    max={60}
                    value={Number(
                      form.grace_minutes ?? effective.grace_minutes ?? 0,
                    )}
                    onChange={(e) =>
                      setField("grace_minutes", Number(e.target.value || 0))
                    }
                    disabled={!canEdit}
                  />
                </FormField>
                ...
                <FormField
                  ...
                  description="Minutes before shift end that still counts as full day (e.g., 30 = 5:30 PM counts as full day)"
                >
                  <Input
                    type="number"
                    min={0}
                    max={60}
                    value={Number(
                      form.clock_out_tolerance_minutes ??
                        effective.clock_out_tolerance_minutes ??
                        30,
                    )}
                    onChange={(e) =>
                      setField(
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setField("auto_close_enabled", checked)
                      }
                      disabled={!canEdit}
                    />
                    <span className="text-sm">
                      {Boolean(
                        form.auto_close_enabled ?? effective.auto_close_enabled,
                      )
                        ? "Enabled"
                        : "Disabled"}
                    </span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  <Input
                    ...
                    onChange={(e) =>
                      setField("overtime_multiplier", Number(e.target.value))
                    }
                    disabled={!canEdit}
                  />
                </FormField>
                ...
                >
                  <Input
                    ...
                    onChange={(e) =>
                      setField("night_diff_multiplier", Number(e.target.value))
                    }
                    disabled={!canEdit}
                  />
                </FormField>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              >
                <Input
                  ...
                  max={12}
                  value={Number(
                    form.holiday_day_hours ?? effective.holiday_day_hours ?? 8,
                  )}
                  onChange={(e) =>
                    setField("holiday_day_hours", Number(e.target.value || 0))
                  }
                  disabled={!canEdit}
                />
              </FormField>
              ...
              >
                <Input
                  ...
                  onChange={(e) =>
                    setField("holiday_regular_pct", Number(e.target.value))
                  }
                  disabled={!canEdit}
                />
              </FormField>
              ...
              >
                <Input
                  ...
                  onChange={(e) =>
                    setField("holiday_special_pct", Number(e.target.value))
                  }
                  disabled={!canEdit}
                />
              </FormField>
                ...
                >
                  <div className="flex items-center gap-3">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setField("regular_holiday_no_work_pays", checked)
                      }
                      disabled={!canEdit}
                    />
                    <span className="text-sm">
                ...
                >
                  <div className="flex items-center gap-3">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setField("special_holiday_no_work_pays", checked)
                      }
                      disabled={!canEdit}
                    />
                    <span className="text-sm">

        ...
        <Wrapper>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-4">
                ...
                <div className="grid grid-cols-2 xl:grid-cols-3 gap-3 content-start">
                    ...
                    <StatCard icon={Receipt} accent="purple" label="Total Revenue" value={stats.totalRevenue} prefix="₱" />
                    <StatCard icon={Receipt} accent="muted" label="Main Stall" value={stats.totalMainRev} prefix="₱" />
                    <StatCard icon={Receipt} accent="muted" label="Sub Stall" value={stats.totalSubRev} prefix="₱" />
                    <StatCard icon={DollarSign} accent="green" label="Total Paid" value={stats.totalPaid} prefix="₱" valueClass="text-success" />
                    <StatCard
                        icon={Wallet}

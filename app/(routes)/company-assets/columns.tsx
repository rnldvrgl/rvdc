...
export function getCompanyAssetColumns({
    ...
    return [
        ...
        },
        {
            ...
            cell: ({ getValue }) => {
                const v = getValue() as string | null
                return v ? <span className="font-mono tabular-nums">{formatCurrency(v)}</span> : <span className="text-muted-foreground">—</span>
            },
        },
        {
            ...
            cell: ({ row }) => {
                ...
                return <span className="font-mono tabular-nums text-sm font-medium text-green-600">{formatCurrency(v)}</span>
            },
        },
        {
        ...
        },
        {
            ...
            header: "Acquired",
            cell: ({ getValue }) => <span className="font-mono tabular-nums">{formatDateFull(getValue() as string)}</span>,
        },
        {
            accessorKey: "status",
            header: "Status",

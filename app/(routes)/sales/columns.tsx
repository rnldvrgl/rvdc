...
export function getSalesTransactionColumns({
    ...
    const columns: ColumnDef<SalesTransaction>[] = [
        ...
        },
        {
            ...
            cell: ({ getValue }) =>
                getValue()
                    ? <span className="font-mono tabular-nums">{formatDate(new Date(getValue() as string), "EEE, MMM dd yyyy • hh:mm a")}</span>
                    : "—",
        },
        {
            ...
            cell: ({ row }) => {
                ...
                return val ? <span className="font-mono tabular-nums">{formatCurrency(Number(val))}</span> : <span className="text-muted-foreground">—</span>
            },
        },
        {
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                return <span className="font-mono tabular-nums">{balance > 0 ? formatCurrency(balance) : formatCurrency(0)}</span>
            },
        },
        {
                    ...
                    <DataTableActions
                        items={[
                            ...
                            },
                            {
                                ...
                                confirmText: `Archive sale transaction from ${row.original.client?.full_name || "this client"
                                    }?`,
                            },
                        ]}
                    />

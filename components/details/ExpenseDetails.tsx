    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-3 flex-wrap">
                ...
                {entity.source && <Badge variant="outline">{entity.source}</Badge>}
            ...
            <Card>
                ...
                <CardContent>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <Detail
                            label="Total Price"
                            value={<AnimatedNumber value={Number(entity.total_price ?? 0)} prefix="₱" />}
                            icon={<DollarSign className="size-4" />}
                        />
                        <Detail
                            label="Paid Amount"
                            value={<AnimatedNumber value={Number(entity.paid_amount ?? 0)} prefix="₱" />}
                        ...
                        <Detail
                            ...
                            value={
                                <AnimatedNumber
                                    value={Number((entity.total_price ?? 0) - (entity.paid_amount ?? 0))}
                                    prefix="₱"
                                />
                            }
                            icon={<DollarSign className="size-4" />}
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <Detail
                                ...
                                value={<AnimatedNumber value={Number(entity.reimbursed_amount ?? 0)} prefix="₱" />}
                                icon={<Wallet className="size-4" />}
                            />
                            <Detail
                                ...
                                value={
                                    <AnimatedNumber
                                        value={Number((entity.total_price ?? 0) - (entity.reimbursed_amount ?? 0))}
                                        prefix="₱"
                                    />
                                }
                                icon={<DollarSign className="size-4" />}

...
import { useLeaveRequests, useMyLeaveBalance } from "@/lib/queries/useAttendance";
...
export function LeaveRequestForm() {
	...
	const remainingBalance = useMemo(() => {
		...
		if (leaveType === "SICK")
			return parseFloat(
				leaveBalance.sick_leave_remaining?.toString() || "0",
			);
		...
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent className="sm:max-w-md">
				<DialogHeader>
					...
					<DialogDescription>
						Submit a leave request for approval. You can request

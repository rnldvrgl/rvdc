        ...
        <Card className="border-0 shadow-sm">
            <CardContent className="space-y-4 sm:space-y-6">
                ...
                {(shopClosedEvent || isShopClosed) && (
                    <div
                        className={`rounded-lg p-4 space-y-3 ${hasApprovedWorkRequest
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2 text-sm font-medium">
                                <AlertCircle
                                    className={`h-4 w-4 ${hasApprovedWorkRequest
                                            ? "text-success"
                                            : hasPendingWorkRequest
                                                ? "text-warning"
                                                : hasDeclinedWorkRequest
                            ...
                            {hasApprovedWorkRequest
                                ...
                                : hasPendingWorkRequest
                                    ...
                                    : hasDeclinedWorkRequest
                                        ...
                                        : `The shop is closed today${shopClosedEvent?.extendedProps.reason &&
                            ...
                            {currentStatus.attendance.paid_hours && (
                                <div className="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg bg-muted/50">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-sm font-medium">
                                            <AnimatedNumber
                                                value={Number(currentStatus.attendance.paid_hours)}

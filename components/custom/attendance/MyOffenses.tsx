...
const getOffenseTypeBadge = (offenseType: string) => {
  const config: Record<string, { color: string; icon: any; label: string }> = {
    ...
    OTHER: {
      color:
        "bg-slate-50 text-slate-700 border-slate-200 dark:bg-slate-950/50 dark:text-slate-400 dark:border-slate-900",
      icon: AlertTriangle,
      label: "Other",
    },
  }
...
export default function MyOffenses() {
    ...
    return (
      <div className="min-h-[400px] flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-muted-foreground">Loading offenses...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6 pb-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">My Offenses</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Track your attendance violations and understand their consequences
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <Card
          className={
            hasReachedLimit ? "border-red-200 dark:border-red-900" : ""
          }
        >
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold mt-1">{warningCount}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold mt-1">{suspensionCount}</p>
              </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-red-700 dark:text-red-300 mt-1">
                You've reached the limit for one or more offense types (3 per
                type). Please contact admin immediately.
              </p>
            </div>
          </div>
        </div>
      ...
      <Card>
        <CardHeader className="border-b">
          <CardTitle className="text-base font-semibold flex items-center gap-1.5">
            ...
            Offense History
            {offenses?.length > 0 && (
              <span className="text-xs bg-amber-100 text-amber-800 dark:bg-amber-900/50 dark:text-amber-200 px-1.5 py-0.5 rounded-full font-medium">
                {offenses.length}
              </span>
            )}
          </CardTitle>
                ...
                >
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <div className="flex items-center gap-2">
                      {getOffenseTypeBadge(offense.offense_type)}
                      {getSeverityBadge(offense.severity_level)}
                    </div>
      ...
      <Card>
        <CardHeader className="border-b">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-lg">Offense Policy</CardTitle>
          </div>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Verbal or written warning issued. Employee counseling may be
                  required.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Temporary suspension without pay. Duration determined by
                  management.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Employment may be terminated. Final decision made by
                  management.
                </p>
              </div>
            </div>

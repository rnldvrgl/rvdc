    ...
    return (
        <div className="w-[280px] p-3 space-y-3">
            ...
            <div className="flex items-center justify-between gap-2">
                ...
                <span className="text-sm font-semibold font-mono tabular-nums">{viewYear}</span>
                <Button
                    type="button"
                    variant="ghost"
                    size="icon"
                    ...
                    <div className={cn(mode === "datetime" && "md:flex")}>
                        {mode !== "time" && (
                            <Calendar
                                ...
                                className="rounded-lg border [--cell-size:--spacing(11)] md:[--cell-size:--spacing(12)] font-mono"
                                formatters={{

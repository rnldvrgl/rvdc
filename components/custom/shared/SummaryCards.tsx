          ...
          data.top_selling_item?.name ? (
            <div className="space-y-1">
              ...
              <div className="text-xs text-muted-foreground">
                {formatNumber(data.top_selling_item.quantity)} sold
              </div>
            </div>
          ) : (
            'N/A'
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                {Array.from({ length: 2 }).map((_, j) => (
                  ...
                  >
                    ...
                    <CardContent className="flex-grow flex flex-col justify-center min-h-[80px]">
                ...
                {group.cards.map((card, j) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <CardContent className="flex-grow flex flex-col justify-center min-h-[45px]">
                        {typeof card.value === 'string' ? (
                          <div className="text-2xl font-bold text-foreground truncate">
                            {card.value}
                          </div>
                        ) : (
                          <div className="space-y-1">{card.value}</div>
                        )}
                      </CardContent>
                    </Card>
                  )

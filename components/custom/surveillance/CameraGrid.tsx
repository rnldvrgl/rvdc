            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  aria-label={enableMic ? "Disable microphone" : "Enable microphone"}
                  className={cn(
                    "p-1.5 rounded-md transition-colors",
                    enableMic
                ...
                >
                  {enableMic ? <Mic className="size-4" /> : <MicOff className="size-4" />}
                </button>
              </TooltipTrigger>
              <TooltipContent side="bottom" className="text-xs">
                {enableMic ? "Disable two-way audio" : "Enable two-way audio"}
              </TooltipContent>
            </Tooltip>
          )}
        </TooltipProvider>

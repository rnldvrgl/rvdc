  ...
  const onSubmit = async (data: OffenseFormValues) => {
    const payload = {
      ...
      suspension_start_date: data.suspension_start_date
        ? data.suspension_start_date.toISOString().split("T")[0]
        : null,
      notes: data.notes || "",
    }
  ...
  return (
    <Form {...form}>
      ...
      >
        {/* Edit Mode Info */}
        {offense && (
          <Alert className="border-blue-200 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-950/20 dark:to-blue-900/20 dark:border-blue-800">
        ...
        {!offense && (
          <Alert className="border-emerald-200 bg-gradient-to-r from-emerald-50 to-emerald-100 dark:from-emerald-950/20 dark:to-emerald-900/20 dark:border-emerald-800">
        ...
        {offense?.severity_level === "SUSPENSION" && (
          <div className="space-y-4 p-6 border-2 rounded-xl bg-gradient-to-br from-orange-50 via-orange-50 to-orange-100 dark:from-orange-950/20 dark:via-orange-950/10 dark:to-orange-900/20 border-orange-300 dark:border-orange-800 shadow-sm">

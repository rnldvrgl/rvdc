...
export function TaxBracketForm({
	...
	const onSubmit = async (data: TaxBracketFormValues) => {
		try {
			...
			console.error("Failed to save tax bracket:", error);
		}
	};
					...
					>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormDescription>
										Type of tax bracket (determines which
										calculations use these brackets)
									</FormDescription>
									<FormMessage />
								</FormItem>
							)}
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormDescription>
												Minimum weekly income for this
												bracket (inclusive)
											</FormDescription>
											<FormMessage />
										</FormItem>
							...
							render={({ field }) => (
								<FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
									<div className="space-y-0.5">
										...
										<FormDescription>
											Only active brackets are used in tax
											calculations
										</FormDescription>
									</div>
									<FormControl>
						...
						<div className="text-xs bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-md p-3">
							...
							<p className="text-blue-800 dark:text-blue-200 mb-2">
								Tax is calculated cumulatively across all
								brackets. Each bracket applies its rate only to
							...
							<ul className="list-disc list-inside space-y-1 text-blue-800 dark:text-blue-200">
								...
								<li>
									₱2,501 - ₱5,000: Base ₱0, Rate 20% on excess
								</li>
								<li>
									If income = ₱5,000: Tax = ₱0 + (₱2,500 ×
									0.20) = ₱500
								</li>
							</ul>
						</div>

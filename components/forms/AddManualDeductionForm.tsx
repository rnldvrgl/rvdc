								...
								{weekStart && (
									<div className="text-sm bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-md p-3">
										...
										<p className="text-blue-800 dark:text-blue-200">
											This recurring deduction will start
						...
						<div className="text-xs bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900 rounded-md p-3">
							...
							{weekStart ? (
								<ul className="list-disc list-inside space-y-1 text-amber-800 dark:text-amber-200">
									<li>
										<strong>One-time</strong>: Deducted from
										this payroll period only
									</li>
									<li>
										<strong>Recurring</strong>: Starts from
										this payroll and continues for the
										number of weeks you specify
									</li>
								</ul>
							) : (
								<ul className="list-disc list-inside space-y-1 text-amber-800 dark:text-amber-200">
									<li>
										One-time: Cash advance ₱1,000 (single
										deduction)
									</li>
									<li>
										Recurring: Loan ₱500/week for 10 weeks
									</li>
									<li>
										Recurring: Equipment damage ₱100/week
										for 5 weeks
									</li>
								</ul>
							)}

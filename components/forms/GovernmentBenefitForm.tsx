...
export function GovernmentBenefitForm({
  ...
  const form = useForm<GovernmentBenefitFormData>({
    ...
    defaultValues: {
      ...
      effective_start: format(new Date(), "yyyy-MM-dd"),
      effective_end: null,
      is_active: true,
      description: "",
    },
  ...
  // Auto-set calculation method for BIR tax
  useEffect(() => {
  ...
  const onSubmit = async (data: GovernmentBenefitFormData) => {
    try {
      ...
      if (isEditing) {
        await updateMutation.mutateAsync({ id: benefit.id, data: payload })
      } else {
              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Employee Share Rate</FormLabel>
                        <FormControl>
                          <Input
                            type="number"
                            step="0.0001"
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Employer Share Rate</FormLabel>
                        <FormControl>
                          <Input
                            type="number"
                            step="0.0001"

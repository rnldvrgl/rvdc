  ...
  const onSubmit = async (data: GovernmentBenefitFormData) => {
    try {
      const payload = {
        ...
        employee_share_rate:
          calculationMethod === "percentage" ? data.employee_share_rate : null,
        employer_share_rate:
          calculationMethod === "percentage" ? data.employer_share_rate : null,
        employee_share_amount:
          calculationMethod === "fixed" ? data.employee_share_amount : null,
        employer_share_amount:
          calculationMethod === "fixed" ? data.employer_share_amount : null,
      }
  ...
  return (
    ...
    >
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {isEditing ? "Edit Government Benefit" : "Add Government Benefit"}
          </DialogTitle>
          <DialogDescription>
            Configure government-mandated benefits and their calculation methods
          </DialogDescription>
        </DialogHeader>
          ...
          >
                ...
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="pagibig">Pag-IBIG / HDMF</SelectItem>
                      <SelectItem value="bir_tax">
                        BIR Withholding Tax
                      </SelectItem>
                    </SelectContent>
                  </Select>
                  <FormDescription>{getBenefitTypeInfo()}</FormDescription>
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    This name will appear in payroll deductions
                  </FormDescription>
                </FormItem>
              )}
            />
            ...
            {calculationMethod === "fixed" && (
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel required>Period Type</FormLabel>
                    <Select
                      onValueChange={field.onChange}
                      value={field.value}
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="monthly">
                          Monthly (divide by 4 for weekly payroll)
                        </SelectItem>
            ...
            {calculationMethod === "fixed" && (
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel required>Employee Share (₱)</FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          step="0.01"
                      ...
                      <FormDescription>
                        {form.watch("period_type") === "monthly"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel required>Employer Share (₱)</FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          step="0.01"
            ...
            {calculationMethod === "percentage" && (
              <>
                <Alert>
                  ...
                  <AlertDescription>
                    Enter rates as decimals: 0.045 for 4.5%, 0.02 for 2%, 0.095
                    for 9.5%
                  </AlertDescription>
                </Alert>
                <div className="grid grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel required>Employee Share Rate</FormLabel>
                        <FormControl>
                          <Input
                            type="number"
                            step="0.0001"
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel required>Employer Share Rate</FormLabel>
                        <FormControl>
                          <Input
                            type="number"
                            step="0.0001"

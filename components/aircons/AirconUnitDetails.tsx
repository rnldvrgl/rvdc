                            ...
                            <div className="rounded-lg border border-blue-200 bg-blue-100 p-3">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    {unit.parts_warranty_status && (
                                        <span
                                            className={`ml-auto inline-flex items-center rounded-md px-2 py-0.5 text-xs font-medium ring-1 ring-inset ${unit.parts_warranty_status === "Active"
                            ...
                            <div className="rounded-lg border border-amber-200 bg-amber-100 p-3">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    {unit.labor_warranty_status && (
                                        <span
                                            className={`ml-auto inline-flex items-center rounded-md px-2 py-0.5 text-xs font-medium ring-1 ring-inset ${unit.labor_warranty_status === "Active"
                                                    ? "bg-green-50 text-success ring-green-600/20"
                        ...
                        {unit.free_cleaning_redeemed !== undefined && (
                            <div className="mt-3 space-y-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span
                                        className={`inline-flex items-center rounded-md px-2 py-0.5 text-xs font-medium ring-1 ring-inset ${unit.free_cleaning_status === "available"
                                                ? "bg-green-50 text-success ring-green-600/20"
